...
for line in sys.stdin:
    ...
    for word in words:
        logpHam = logpHam +  MODEL.get(word, (0,0))[0]
        logpSpam = logpSpam + MODEL.get(word, (0,0))[1]
        
    logpHam = MODEL.get("ClassPriors", (0,0))[0] + logpHam
    logpSpam = MODEL.get("ClassPriors", (0,0))[1] + logpSpam
    if logpHam >= logpSpam:
        pred_class = 0
    else: 
        pred_class = 1
